...
// function over2() {
//     let change = document.getElementsByClassName("scambia");
//     for(let i=0; i < change.length; i++) {
//         let tempSrc = change[i].src;
//         change[i].src = change[i+1].src;
//         change[i+1].src = tempSrc;
//     }
// }
...
window.onload = function() {
    let imgUno = document.getElementById("one");
    let imgTwo = document.getElementById("two");
    let tempOne = imgUno.src;
    let tempTwo = imgTwo.src;
    ...
    function duplica1() {
        resetImg(); // Reset to original state

        imgTwo.src = imgUno.src;
    }
    ...
    const intervallo = setInterval(scambia1, 1000);;

    function ruota() {
        intervallo2 = intervallo;
    }

    document.getElementById("duplica1").onclick = duplica1;
    document.getElementById("duplica2").onclick = duplica2;
    document.getElementById("scambia").onclick = scambia1;
    document.getElementById("reset").onclick = resetAll;
    document.getElementById("ruota").onclick = ruota;
    ;
